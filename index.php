...
<div class="container-fluid about-house">
    <div class="row">
        ...
        <div class="col-md-6">    
            ...
            <p class="attention text-center"><span class="red">Внимание!</span> Мы не предлагаем долевое участие. Дом построен и <a href="allow.php" target="_blank">сдан в эксплуатацию</a>. Вы получаете квартиры в готовом доме с зарегистрированным правом собственности!</p>
