...
<div id="second-row-wrap" class="text-center">
    <a  href="#" id="flat-green" class="flat-plan-cut"></a><a href="#" id="flat-violet" class="flat-plan-cut"></a><a href="#" id="flat-yellow" class="flat-plan-cut sold"></a><a href="#" id="flat-turq2" class="flat-plan-cut"><div id="fake-green-div"></div></a>
</div>
